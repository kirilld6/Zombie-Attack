...
def start_screen_game(surface):
    ...
    text_draw(surface, 'Zombie Attack', 64, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 7)
    text_draw(surface, 'Use the arrows on the keyboard to control the Player', 18, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 3)
    text_draw(surface, 'During the game, press the SPACE bar to start shooting', 18, SCREEN_WIDTH / 2,
              SCREEN_HEIGHT / 2.5)
    text_draw(surface, "Press ENTER key to begin", 32, SCREEN_WIDTH / 2, SCREEN_HEIGHT * 2 / 3.5)
    pg.display.flip()
...
def game_over_screen(surface, score):
    ...
    text_draw(surface, "Press ENTER  to new game", 20, SCREEN_WIDTH / 2, SCREEN_HEIGHT * 2 / 5)
